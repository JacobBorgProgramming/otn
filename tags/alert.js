function alert(){
    ...
    document.getElementById("acontent1").innerHTML = 'LastPass password management service experiences "security incident". '
    document.getElementById("alink").innerHTML = release
    document.getElementById("alink").href = 'https://blog.lastpass.com/2022/12/notice-of-recent-security-incident/'
}
