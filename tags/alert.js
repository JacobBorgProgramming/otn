function alert(){
    ...
    document.getElementById("acontent1").innerHTML = 'Bump-Stock Ban Heads to SCOTUS '
    document.getElementById("alink").innerHTML = article
    document.getElementById("alink").href = 'https://www.scotusblog.com/2024/02/bump-stock-ban-comes-before-supreme-court/'
}
