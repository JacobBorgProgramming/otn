function alert(){
    ...
    document.getElementById("acontent1").innerHTML = 'Keep up with the price of eggs and more! '
    document.getElementById("alink").innerHTML = data
    document.getElementById("alink").href = 'https://www.openteanews.com/data/economy/economytracker.html'
}
