function alert(){
    ...
    document.getElementById("acontent1").innerHTML = 'Chinese High-Altitude Surveillance Balloon in US airspace. '
    document.getElementById("alink").innerHTML = release
    document.getElementById("alink").href = 'https://www.defense.gov/News/News-Stories/Article/Article/3287177/us-tracking-high-altitude-surveillance-balloon/'
}
