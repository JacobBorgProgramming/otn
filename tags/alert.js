function alert(){
    ...
    document.getElementById("acontent1").innerHTML = 'Former President Donald J. Trump to be arraigned. '
    document.getElementById("alink").innerHTML = tweet
    document.getElementById("alink").href = 'https://twitter.com/ManhattanDA/status/1641579988360019968'
}
