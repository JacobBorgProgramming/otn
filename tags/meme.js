function memes(){
    ...
    document.getElementById("mcontent1").src = 'https://www.openteanews.com/assets/img/disrespectheretics.png'
    document.getElementById("mcontent2").innerHTML = ''
    document.getElementById("mlink1").innerHTML = ''
    document.getElementById("mlink1").href = ''
    document.getElementById("mtime1").innerHTML = '1/18/24 2:25pm MST'

    /* Recent 2 */

    document.getElementById("mtitle2").innerHTML = ''
    document.getElementById("mcontent3").src = 'https://www.openteanews.com/assets/img/IMG_9139.png'
