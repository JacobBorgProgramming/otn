function latest(){
   ...
   var l4 = "1"
    ...
    document.getElementById("link"+l3).href = 'https://ethics.house.gov/press-releases/statement-acting-chairwoman-and-acting-ranking-member-committee-ethics-regarding-3'
    document.getElementById("time"+l3).innerHTML = '12/7/22 12:50pm MST'
    document.getElementById("telegram"+l3).href = 'https://t.me/openteanews/102'
