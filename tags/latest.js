function latest(){
    ...
    document.getElementById("link"+l3).innerHTML = data
    document.getElementById("link"+l3).href = 'https://fred.stlouisfed.org/series/APU0000708111'
    document.getElementById("time"+l3).innerHTML = '1/10/23 6:01pm MST'
    document.getElementById("telegram"+l3).href = 'https://t.me/openteanews/138'
